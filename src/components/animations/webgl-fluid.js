/* eslint-disable @typescript-eslint/no-this-alias -- vendored third-party file (webgl-fluid), minified; this-aliasing is inherent to the original bundle output, do not rewrite */
